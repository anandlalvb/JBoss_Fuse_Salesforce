...
public class TaskStatus extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Task Status Value ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        description.setLabelPlural("Task Status Value");
        description.setLabel("Task Status Value");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/TaskStatus/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/TaskStatus");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/TaskStatus/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("TaskStatus");
