...
public class ContractStatus extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Contract Status Value ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField5 = createField("StatusCode", "Status Code", "picklist", "xsd:string", 40, false, true, false, false, false, false, false);
        ...
        description.setLabelPlural("Contract Status Value");
        description.setLabel("Contract Status Value");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/ContractStatus/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/ContractStatus");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/ContractStatus/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("ContractStatus");
