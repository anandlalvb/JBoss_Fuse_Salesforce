...
public class SiteFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Site");
        description.setLabel("Site");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/SiteFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/SiteFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/SiteFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("SiteFeed");
