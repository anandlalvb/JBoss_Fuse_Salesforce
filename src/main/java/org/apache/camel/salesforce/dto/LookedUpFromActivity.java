...
public class LookedUpFromActivity extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Lookups from Activities");
        description.setLabel("Lookups from Activity");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/LookedUpFromActivity/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/LookedUpFromActivity");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/LookedUpFromActivity/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("LookedUpFromActivity");
