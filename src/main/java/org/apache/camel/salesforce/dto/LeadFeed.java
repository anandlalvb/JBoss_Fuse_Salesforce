...
public class LeadFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Lead Feed");
        description.setLabel("Lead Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/LeadFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/LeadFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/LeadFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("LeadFeed");
