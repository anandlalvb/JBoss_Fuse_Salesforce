...
public class RecordType extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Record Type ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField3 = createField("DeveloperName", "Record Type Name", "string", "xsd:string", 80, false, false, false, false, false, false, false);
        ...
        final SObjectField sObjectField6 = createField("BusinessProcessId", "Business Process ID", "reference", "tns:ID", 18, false, true, false, false, false, false, false);
        fields1.add(sObjectField6);
        final SObjectField sObjectField7 = createField("SobjectType", "Sobject Type Name", "picklist", "xsd:string", 40, false, false, false, false, false, false, false);
        ...
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/RecordType/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/RecordType");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/RecordType/{ID}");
