...
public class LeadShare extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Lead Share ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        fields1.add(sObjectField1);
        final SObjectField sObjectField2 = createField("LeadId", "Lead ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        ...
        final SObjectField sObjectField4 = createField("LeadAccessLevel", "Lead Access", "picklist", "xsd:string", 40, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Lead Share");
        description.setLabel("Lead Share");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/LeadShare/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/LeadShare");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/LeadShare/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("LeadShare");
