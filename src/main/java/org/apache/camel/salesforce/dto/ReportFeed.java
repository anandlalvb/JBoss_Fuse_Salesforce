...
public class ReportFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Report Feed");
        description.setLabel("Report Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/ReportFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/ReportFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/ReportFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("ReportFeed");
