...
public class UserFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("User Feed");
        description.setLabel("User Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/UserFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/UserFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/UserFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("UserFeed");
