...
public class CaseFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Case Feed");
        description.setLabel("Case Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/CaseFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/CaseFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/CaseFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("CaseFeed");
