...
public class Community extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Zone ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField7 = createField("Name", "Name", "string", "xsd:string", 80, false, false, true, false, false, false, true);
        ...
        description.setLabelPlural("Zones");
        description.setLabel("Zone");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/Community/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/Community");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/Community/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("Community");
