...
public class PartnerRole extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Partner Role Value ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField4 = createField("ReverseRole", "Reverse Role", "picklist", "xsd:string", 40, false, true, false, false, false, false, false);
        ...
        description.setLabelPlural("Partner Role Value");
        description.setLabel("Partner Role Value");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/PartnerRole/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/PartnerRole");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/PartnerRole/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("PartnerRole");
