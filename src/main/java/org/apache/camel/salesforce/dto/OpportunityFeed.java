...
public class OpportunityFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Opportunity Feed");
        description.setLabel("Opportunity Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/OpportunityFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/OpportunityFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/OpportunityFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("OpportunityFeed");
