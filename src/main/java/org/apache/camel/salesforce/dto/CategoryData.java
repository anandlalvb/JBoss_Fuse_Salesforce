...
public class CategoryData extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Category Data ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        fields1.add(sObjectField1);
        final SObjectField sObjectField2 = createField("CategoryNodeId", "Category Node ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        fields1.add(sObjectField2);
        final SObjectField sObjectField3 = createField("RelatedSobjectId", "SObject ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Category Data");
        description.setLabel("Category Data");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/CategoryData/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/CategoryData");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/CategoryData/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("CategoryData");
