...
public enum FieldPermissions_FieldEnum {
    ...
    // Asset.AssetLevel
    ASSET_ASSETLEVEL("Asset.AssetLevel"),
    // Asset.AssetProvidedBy
    ASSET_ASSETPROVIDEDBY("Asset.AssetProvidedBy"),
    // Asset.AssetServicedBy
    ASSET_ASSETSERVICEDBY("Asset.AssetServicedBy"),
    // Asset.Contact
    ...
    // Asset.IsInternal
    ASSET_ISINTERNAL("Asset.IsInternal"),
    // Asset.Price
    ...
    ASSET_STOCKKEEPINGUNIT("Asset.StockKeepingUnit"),
    // Asset.UsageEndDate
    ASSET_USAGEENDDATE("Asset.UsageEndDate"),
    // AssetRelationship.RelationshipType
    ASSETRELATIONSHIP_RELATIONSHIPTYPE("AssetRelationship.RelationshipType"),
    // Campaign.ActualCost
    ...
    PRODUCT2_STOCKKEEPINGUNIT("Product2.StockKeepingUnit"),
