...
public class OrderItemHistory extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Order Product History ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField3 = createField("OrderItemId", "Order Product ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Order Product History");
        description.setLabel("Order Product History");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/OrderItemHistory/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/OrderItemHistory");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/OrderItemHistory/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("OrderItemHistory");
