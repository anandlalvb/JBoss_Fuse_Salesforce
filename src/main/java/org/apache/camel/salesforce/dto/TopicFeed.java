...
public class TopicFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Topic Feed");
        description.setLabel("Topic Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/TopicFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/TopicFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/TopicFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("TopicFeed");
