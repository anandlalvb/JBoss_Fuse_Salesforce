...
public class SecureAgent extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Secure Agent ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField11 = createField("AgentKey", "Agent Key", "string", "xsd:string", 255, false, true, false, false, false, false, false);
        fields1.add(sObjectField11);
        final SObjectField sObjectField12 = createField("ProxyUserId", "User ID", "reference", "tns:ID", 18, false, true, false, false, false, false, false);
        fields1.add(sObjectField12);

        description.setLabelPlural("Secure Agents");
        description.setLabel("Secure Agent");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/SecureAgent/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/SecureAgent");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/SecureAgent/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("SecureAgent");
