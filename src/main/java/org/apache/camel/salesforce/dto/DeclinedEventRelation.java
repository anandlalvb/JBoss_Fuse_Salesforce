...
public class DeclinedEventRelation extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Declined Event Relations");
        description.setLabel("Declined Event Relation");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/DeclinedEventRelation/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/DeclinedEventRelation");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/DeclinedEventRelation/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("DeclinedEventRelation");
