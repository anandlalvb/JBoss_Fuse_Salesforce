...
public class OrderFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Order Feed");
        description.setLabel("Order Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/OrderFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/OrderFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/OrderFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("OrderFeed");
