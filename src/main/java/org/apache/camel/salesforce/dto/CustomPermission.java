...
public class CustomPermission extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Custom Permission ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField12 = createField("Description", "Description", "textarea", "xsd:string", 255, false, true, false, false, false, false, false);
        fields1.add(sObjectField12);

        description.setLabelPlural("Custom Permissions");
        description.setLabel("Custom Permission");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/CustomPermission/describe");
        sObjectDescriptionUrls1.setLayouts("/services/data/v34.0/sobjects/CustomPermission/describe/layouts");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/CustomPermission");
        sObjectDescriptionUrls1.setUiEditTemplate("https://na57.salesforce.com/{ID}/e");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/CustomPermission/{ID}");
        sObjectDescriptionUrls1.setCompactLayouts("/services/data/v34.0/sobjects/CustomPermission/describe/compactLayouts");
        sObjectDescriptionUrls1.setUiNewRecord("https://na57.salesforce.com/0CP/e");
        sObjectDescriptionUrls1.setUiDetailTemplate("https://na57.salesforce.com/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("CustomPermission");
