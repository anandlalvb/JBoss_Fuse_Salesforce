...
public class Announcement extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Announcement ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField8 = createField("FeedItemId", "Feed Item ID", "reference", "tns:ID", 18, true, false, false, false, false, false, false);
        fields1.add(sObjectField8);
        final SObjectField sObjectField9 = createField("ExpirationDate", "Expiration Date", "datetime", "xsd:dateTime", 0, false, false, false, false, false, false, false);
        fields1.add(sObjectField9);
        final SObjectField sObjectField10 = createField("ParentId", "Parent ID", "reference", "tns:ID", 18, false, true, false, false, false, false, false);
        fields1.add(sObjectField10);

        description.setLabelPlural("Announcements");
        description.setLabel("Announcement");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/Announcement/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/Announcement");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/Announcement/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("Announcement");
