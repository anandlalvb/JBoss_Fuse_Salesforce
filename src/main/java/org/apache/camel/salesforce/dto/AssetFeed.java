...
public class AssetFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Asset Feed");
        description.setLabel("Asset Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/AssetFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/AssetFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/AssetFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("AssetFeed");
