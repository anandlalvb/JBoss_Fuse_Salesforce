...
public class DashboardComponentFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Dashboard Component Feed");
        description.setLabel("Dashboard Component Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/DashboardComponentFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/DashboardComponentFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/DashboardComponentFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("DashboardComponentFeed");
