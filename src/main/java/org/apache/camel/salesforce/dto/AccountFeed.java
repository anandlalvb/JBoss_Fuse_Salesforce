...
public class AccountFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Account Feed");
        description.setLabel("Account Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/AccountFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/AccountFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/AccountFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("AccountFeed");
