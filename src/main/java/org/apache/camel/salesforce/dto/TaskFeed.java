...
public class TaskFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Task Feed");
        description.setLabel("Task Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/TaskFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/TaskFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/TaskFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("TaskFeed");
