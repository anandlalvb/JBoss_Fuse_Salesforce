...
public enum QuickTextShare_RowCauseEnum {
    ...
    private QuickTextShare_RowCauseEnum(String value) {
        this.value = value;
    }
    ...
    @JsonCreator
    public static QuickTextShare_RowCauseEnum fromValue(String value) {
        for (QuickTextShare_RowCauseEnum e : QuickTextShare_RowCauseEnum.values()) {
