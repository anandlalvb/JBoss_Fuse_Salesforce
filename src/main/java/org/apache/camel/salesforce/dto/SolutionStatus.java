...
public class SolutionStatus extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Solution Status Value ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField5 = createField("IsReviewed", "Is Reviewed", "boolean", "xsd:boolean", 0, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Solution Status Value");
        description.setLabel("Solution Status Value");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/SolutionStatus/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/SolutionStatus");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/SolutionStatus/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("SolutionStatus");
