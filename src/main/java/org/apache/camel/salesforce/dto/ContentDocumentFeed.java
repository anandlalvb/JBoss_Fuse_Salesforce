...
public class ContentDocumentFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("ContentDocument Feed");
        description.setLabel("ContentDocument Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/ContentDocumentFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/ContentDocumentFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/ContentDocumentFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("ContentDocumentFeed");
