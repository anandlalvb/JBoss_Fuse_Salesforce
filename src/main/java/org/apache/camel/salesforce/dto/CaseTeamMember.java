...
public class CaseTeamMember extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Team Member Id", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField4 = createField("TeamTemplateMemberId", "Team Template Member ID", "reference", "tns:ID", 18, false, true, false, false, false, false, false);
        fields1.add(sObjectField4);
        final SObjectField sObjectField5 = createField("TeamRoleId", "Team Role ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Case Team Member");
        description.setLabel("Case Team Member");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/CaseTeamMember/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/CaseTeamMember");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/CaseTeamMember/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("CaseTeamMember");
