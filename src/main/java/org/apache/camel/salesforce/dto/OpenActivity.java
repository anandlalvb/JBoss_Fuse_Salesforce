...
public class OpenActivity extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Open Activities");
        description.setLabel("Open Activity");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/OpenActivity/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/OpenActivity");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/OpenActivity/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("OpenActivity");
