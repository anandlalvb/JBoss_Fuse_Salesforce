...
public class EventFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Event Feed");
        description.setLabel("Event Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/EventFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/EventFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/EventFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("EventFeed");
