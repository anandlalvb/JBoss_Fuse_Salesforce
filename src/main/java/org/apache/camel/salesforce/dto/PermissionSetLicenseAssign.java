...
public class PermissionSetLicenseAssign extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Permission Set License Assignment ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField7 = createField("SystemModstamp", "Date Assigned", "datetime", "xsd:dateTime", 0, false, false, false, false, false, false, false);
        ...
        final SObjectField sObjectField9 = createField("AssigneeId", "User ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        fields1.add(sObjectField9);

        description.setLabelPlural("Permission Set License Assignments");
        description.setLabel("Permission Set License Assignment");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/PermissionSetLicenseAssign/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/PermissionSetLicenseAssign");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/PermissionSetLicenseAssign/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("PermissionSetLicenseAssign");
