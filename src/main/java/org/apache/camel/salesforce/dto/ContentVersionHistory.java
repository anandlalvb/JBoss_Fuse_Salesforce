...
public class ContentVersionHistory extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Content Version ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField3 = createField("ContentVersionId", "ContentVersion ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Content Version History");
        description.setLabel("Content Version History");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/ContentVersionHistory/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/ContentVersionHistory");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/ContentVersionHistory/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("ContentVersionHistory");
