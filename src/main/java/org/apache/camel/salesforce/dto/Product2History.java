...
public class Product2History extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Product Stage ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField3 = createField("Product2Id", "Product ID", "reference", "tns:ID", 18, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Product History");
        description.setLabel("Product History");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/Product2History/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/Product2History");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/Product2History/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("Product2History");
