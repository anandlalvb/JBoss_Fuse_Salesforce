...
public class LeadStatus extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Lead Status Value ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField5 = createField("IsConverted", "Is Converted", "boolean", "xsd:boolean", 0, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Lead Status Value");
        description.setLabel("Lead Status Value");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/LeadStatus/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/LeadStatus");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/LeadStatus/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("LeadStatus");
