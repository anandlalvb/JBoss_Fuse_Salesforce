...
public class CaseTeamRole extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Team Role Id", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField3 = createField("AccessLevel", "Access Level", "picklist", "xsd:string", 40, false, false, false, false, false, false, false);
        fields1.add(sObjectField3);
        final SObjectField sObjectField4 = createField("PreferencesVisibleInCSP", "Visible in Customer Portal", "boolean", "xsd:boolean", 0, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Case Team Member Role");
        description.setLabel("Case Team Member Role");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/CaseTeamRole/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/CaseTeamRole");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/CaseTeamRole/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("CaseTeamRole");
