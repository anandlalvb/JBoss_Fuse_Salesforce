...
public class AcceptedEventRelation extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Accepted Event Relations");
        description.setLabel("Accepted Event Relation");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/AcceptedEventRelation/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/AcceptedEventRelation");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/AcceptedEventRelation/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("AcceptedEventRelation");
