...
public class ContactFeed extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        description.setLabelPlural("Contact Feed");
        description.setLabel("Contact Feed");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/ContactFeed/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/ContactFeed");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/ContactFeed/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("ContactFeed");
