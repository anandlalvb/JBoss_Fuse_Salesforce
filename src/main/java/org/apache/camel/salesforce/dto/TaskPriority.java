...
public class TaskPriority extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Task Priority Value ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField5 = createField("IsHighPriority", "Is High Priority", "boolean", "xsd:boolean", 0, false, false, false, false, false, false, false);
        ...
        description.setLabelPlural("Task Priority Value");
        description.setLabel("Task Priority Value");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/TaskPriority/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/TaskPriority");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/TaskPriority/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("TaskPriority");
