...
/**
 * Salesforce DTO for SObject ContentFolder
 */
@Generated("org.apache.camel.maven.CamelSalesforceMojo")
@XStreamAlias("ContentFolder")
public class ContentFolder extends AbstractDescribedSObjectBase {
    ...
    private static SObjectDescription createSObjectDescription() {
        ...
        final SObjectField sObjectField1 = createField("Id", "Content Folder ID", "id", "tns:ID", 18, false, false, false, false, false, false, true);
        ...
        final SObjectField sObjectField9 = createField("ParentContentFolderId", "Parent Content Folder ID", "reference", "tns:ID", 18, false, true, false, false, false, false, false);
        fields1.add(sObjectField9);

        description.setLabelPlural("Content Folders");
        description.setLabel("Content Folder");

        final SObjectDescriptionUrls sObjectDescriptionUrls1 = new SObjectDescriptionUrls();
        sObjectDescriptionUrls1.setDescribe("/services/data/v34.0/sobjects/ContentFolder/describe");
        sObjectDescriptionUrls1.setSobject("/services/data/v34.0/sobjects/ContentFolder");
        sObjectDescriptionUrls1.setRowTemplate("/services/data/v34.0/sobjects/ContentFolder/{ID}");
        description.setUrls(sObjectDescriptionUrls1);
        description.setName("ContentFolder");
